...
expirydate = datetime.date(2022, 9, 30)
...
if(expirydate>today):
    ...
    Final = now.replace(hour=17, minute=00, second=0, microsecond=0)
    ...
    if (True):
        ...
        print("31st Aug 2022, 07:30 AM- 11:30 AM")
        print("31st Aug 2022, 02:00 PM- 02:30 PM")
        print("2nd Sept 2022, 05:00 PM- 05:30 PM")
        print("31st Aug 2022, 10:00 PM- 11:30 PM")
        print("Please play on the given time, and ")
        print("If you think it is an error contact")
        print(" admin on telegram @rxcehack143 ")
